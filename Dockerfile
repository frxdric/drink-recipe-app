...
# into this layer.
RUN --mount=type=bind,source=./recipe-app-backend/package.json,target=package.json \
    --mount=type=bind,source=./recipe-app-backend/package-lock.json,target=package-lock.json \
